...
/**
 * Checks if provided input is valid using Luhn's checksum algorithm
 *
...
/**
 * Calculates the value of Luhn's remainder
 *
 * @param {string} input
 * @returns {number}
 */
module.exports.calculateLuhnRemainder = input => {
    const luhnRemainder = napiLuhnImpl.calculateLuhnRemainder(input);
    return luhnRemainder;
};
